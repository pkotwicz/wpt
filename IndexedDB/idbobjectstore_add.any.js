...
}, 'add() adds with an out-of-line key');
...
}, 'add() records with same key already exists');
...
}, 'add() adds where an index has unique:true specified');
...
}, 'add() autoIncrements and inline keys');
...
}, 'add() autoIncrements and out-of-line keys');
...
async_test(t => {
  ...
  }, 'add() attempts to add a record that does not meet the constraints of an object store\'s inline key requirements');
...
}, 'add() attempt to add a record where the record\'s key does not meet the constraints of a valid key');
...
}, 'add() attempt to add a record where the record\'s in-line key is not defined');
...
}, 'add() attempt to add a record where the out of line key provided does not meet the constraints of a valid key');
...
}, 'add() adds a record where a value being indexed does not meet the constraints of a valid key');

...
const tests = [
  ...
  {
    name:
        '[lstm] DataError is expected if the size of input.dimensions is not 3',
  ...
  {
    name:
        '[lstm] DataError is expected if the size of input.dimensions[0] does not equal to steps',
  ...
  {
    name:
        '[lstm] DataError is expected if the size of recurrentWeight.dimensions is not 3',
    input: {dataType: 'float32', dimensions: [steps, batchSize, inputSize]},
    weight: {
      dataType: 'float32',
      dimensions: [numDirections, 4 * hiddenSize, inputSize]
  ...
  {
    name:
        '[lstm] DataError is expected if the size of options.bias.dimensions is not 2',
    input: {dataType: 'float16', dimensions: [steps, batchSize, inputSize]},
    weight: {
      dataType: 'float16',
      dimensions: [numDirections, 4 * hiddenSize, inputSize]
